...
import com.example.shrisha.newsapp.utils.HttpHelper;
...
public class NewsLoader extends AsyncTaskLoader<List<NewsArticle>> {
    ...
    public List<NewsArticle> loadInBackground() {
        ...
        List<NewsArticle> newsData = HttpHelper.fetchNewsData(mUrl);
        for (NewsArticle article: newsData) {

            ImageCacheManager.putBitmap(getContext(), article, article.getImageBitmap());
        }
        return newsData;
