    ...
    private static List<NewsArticle> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < articles.length(); i++) {
                ...
                NewsArticle newsArticleItem = new NewsArticle(title, newsUrl, bitmap, description);
                newsArticleList.add(newsArticleItem);
            }

        } catch (JSONException e) {
            Log.e("HttpHelper", "Problem parsing the news JSON results", e);
        }
